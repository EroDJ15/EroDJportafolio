...
function Navbar({ toggleDarkMode }) {
  ...
  return (
    <nav className="flex items-center justify-between bg-blue-100 dark:bg-primary p-2">
      ...
      <button className="absolute origin-bottom-left sm:[botton-4]right-3 py-3 pt-2 sm:hidden text-black dark:text-cyan-50" onClick={toggleMenu}>
      ...
      <button className="flex items-center dark:bg-primary dark:text-cyan-50 px-1 py-0 sm:px-5 mt-0" id="dark" onClick={toggleDarkMode}>
        {toggleDarkMode ? (
